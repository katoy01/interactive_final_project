...
function preload() {
    ...
    eggsalad_menu = loadImage('./assets/image/eggsalad_menu.png');
     bruschetta_menu = loadImage('./assets/image/bruschetta_menu.png');
     cheesybread_menu = loadImage('./assets/image/cheesybread_menu.png');
